...
**Last verified:** 2026-07-23 against `main` commit `ca38a90040d3a50a0d470262cf78b7e274f3761c` and GitHub pull-request state.
...
| Migration `0044` | **In development** | Issue #11 approves a bounded API-management foundation covering clients, hashed-key lifecycle metadata, scopes, and rate-limit assignments. |
...
Migration 0044 Draft PR under Issue #11. Do not start migration 0045.
